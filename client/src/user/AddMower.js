...
import { createMower } from './apiUser'
...
const AddMower = () => {
    ...
    useEffect(() => {
        ...
        setValues({ ...values, added_by: userId,customer_id:userId, error: false, btnloading: false });
    ...
    const clickSubmit = (event) => {
        event.preventDefault();
        setValues({ ...values, added_by: userId, customer_id: userId, error: false, btnloading: true });
        createMower({
            values
        })
            .then(data => {
