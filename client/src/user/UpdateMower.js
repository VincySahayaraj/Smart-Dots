...
import { updateMower, getMowerDetailsById } from './apiUser'
...
const UpdateMower = ({ match }) => {
    ...
    useEffect(() => {
        ...
        setValues({ ...values, updated_by: userId, customer_id: userId, error: false, btnloading: false });
    ...
    const clickSubmit = (event) => {
        ...
        setValues({ ...values, updated_by: userId, customer_id: userId, thirdYearwarranty: purchaseFromSmartdots ? thirdYearwarranty : '', error: false, btnloading: true });
            ...
            {isLoading ?
                (
                    ...
                    <form onSubmit={clickSubmit} >
                        ...
                        <div><Link className="nav-link" to="/user/manage/mowers">Go Back to List </Link></div>
                    </form>
                )
            }
        </>
    ...
    const showSuccess = () => (
        success && <Redirect to="/user/manage/mowers" />
    );
